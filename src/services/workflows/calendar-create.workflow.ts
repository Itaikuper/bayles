 ...
 */
export async function runCalendarCreateWorkflow(
  jid: string,
  slots: CalendarCreateSlots,
  message: proto.IWebMessageInfo,
  deps: CalendarCreateDeps,
): Promise<boolean> {
  ...
  if (parsed.note) lines.push(`_${parsed.note}_`);
...
function pickTargetCalendar(
  ...
  repo: ReturnType<typeof getCalendarLinkRepository>,
  jid: string,
): typeof links[number] {
  if (hint) {
